...
/**
 * @ Author     ：苏俊宾
 * @ Date       ：Created in 20:40 2020/1/6
 * @ Description：雪花算法
 **/
public class Snowflake {
    ...
    public static void main(String[] args) {
        ...
        try {
            // getSnowflakeId();
            System.out.println("1" + getSnowflakeId());
            System.out.println("2" + getSnowflakeId());
            System.out.println("3" + getSnowflakeId());
            System.out.println("4" + getSnowflakeId());
        } catch (Exception e) {
